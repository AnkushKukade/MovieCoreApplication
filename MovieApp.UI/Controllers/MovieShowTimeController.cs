...
namespace MovieApp.UI.Controllers
{
    public class MovieShowTimeController : Controller
    {
        ...
        public async Task<IActionResult> ShowMovieTime()
        {
            ...
            {
                string endPoint = _configuration["WebApiBaseUrl"] + "MovieShowTime/SelectMovieShowTime";
        ...
        public async Task<IActionResult> UpdateMovieshowTimes(int ShowId)
        {
            using (HttpClient client = new HttpClient())
            {
                string endPoint = _configuration["WebApiBaseUrl"] + "MovieShowTime/GetSpecificMovieShowTime?id=" + ShowId;
                using (var response = await client.GetAsync(endPoint))
                {
                    if (response.StatusCode == System.Net.HttpStatusCode.OK)
                    {
        ...
        public async Task<IActionResult> DeleteMovieshowTimes(MovieShowTimeModel movieShowTimeModel)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                string endPoint = _configuration["WebApiBaseUrl"] + "MovieShowTime/DeleteMovieShowTime?id=" + movieShowTimeModel.ShowId;
